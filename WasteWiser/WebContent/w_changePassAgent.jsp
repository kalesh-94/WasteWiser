...
<body>
    <div class="header">
        <div class="header-content">
            ...
            <div class="nav-links">
                ...
                <a href="updatePickupStatus.jsp">Update Status</a>
                <a href="agentChangePassword.jsp">Change Password</a>
    ...
    <div class="form-container">
        ...
        <form action="agentChangePassword" method="post" onsubmit="return validatePassword()">
            ...
            <a href="r_agentDashboard.html" class="btn btn-secondary">

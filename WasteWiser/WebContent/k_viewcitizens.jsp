...
<title>View Citizens - WasteWise</title>
		...
		<div class="header-content">
			...
			<div class="nav-links">
				...
				<a href="#"
					...
					Citizens</a> <a href="h_addAgents.html"
					style="color: white; text-decoration: none; margin-left: 20px;">Add
					Agent</a>
			</div>
		</div>
	</div>

	<h1 class="page-title">View Citizens</h1>
		...
		<table>
			...
			<tbody>
				<%
					...
					PreparedStatement pstmt7 = con.prepareStatement("select * from citizens");
				...
				<tr>
					...
					<td><a href="l_citizenDelete.jsp?ciId=<%=rs.getInt(1)%>"
